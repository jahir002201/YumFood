"""
Django settings for yumfood project.
...
SECRET_KEY = 'django-insecure-np^tc0i1fcpvxd+^%nf8=y+_=71unm)gz*h39bl87hc0nh$@ku'
...
DJOSER = {
    ...
    'EMAIL_FRONTEND_SITE_NAME': 'YumFood',
